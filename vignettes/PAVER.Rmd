...
PAVER is an R package for the visualization and interpretation of pathway analysis results. PAVER uses a combination of hierarchical clustering, dimensionality reduction, and visualization techniques to identify and characterize similar pathways in a given dataset. PAVER is designed to be used with any GSEA tool that produces a ranked list of pathways, like [GSEA](https://www.gsea-msigdb.org/gsea/index.jsp) or [Enrichr](https://maayanlab.cloud/Enrichr/).
